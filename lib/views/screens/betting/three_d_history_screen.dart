...
import 'package:sport_fm/controller/three_hist_controller.dart';
...
class ThreeDHistoryScreen extends StatelessWidget {
  const ThreeDHistoryScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final tController = Get.put(ThreeDHisController());
