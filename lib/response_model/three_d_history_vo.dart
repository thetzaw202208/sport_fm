class ThreeDHistoryVo {
  int? status;
  ResData? resData;

  ThreeDHistoryVo({this.status, this.resData});

  ThreeDHistoryVo.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class DetailData {
  ...
  DetailData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    threeLedgerId = json['three_ledger_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = id;
    data['user_id'] = userId;
    data['three_ledger_id'] = threeLedgerId;
