...
import 'package:sport_fm/views/screens/transaction/choose_bank_type_screen.dart';
import 'package:sport_fm/views/screens/transaction/transaction_history.dart';
                ...
                children: [
                  Row(
                    ...
                    children: [
                      InkWell(
                        onTap: (){
Get.to(ChooseBankScreen(fromScreen: 'd'));
                        },
                        child: Container(
                          ...
                          child:Column(
                            ...
                            children: [
                              kSizedBoxH10,
                              Image.asset('assets/images/deposit.webp',width: 80.w,height: 80.h,),
                              Container(
                                  width: MediaQuery.of(context).size.width*.4,
                                  height: 30.h,
                                  decoration: BoxDecoration(
                                  ...
                                  child: Center(child: CustomText(text: 'deposit'.tr,color: primaryColor,fontWeight: FontWeight.bold,)))
                            ],
                          ) ,
                        ),
                      ),
                      InkWell(
                        onTap: (){
                          ...
                          Get.to(ChooseBankScreen(fromScreen: 'w'));
                        },
                        child: Container(
                          width: MediaQuery.of(context).size.width*.4,
                          height: MediaQuery.of(context).size.width*.4,
                          ...
                          child:Column(
                            ...
                            children: [
                              kSizedBoxH10,
                              Image.asset('assets/images/withdraw.webp',width: 80.w,height: 80.h,),
                              Container(
                                  width: MediaQuery.of(context).size.width*.4,
                                  height: 30.h,
                                  decoration: BoxDecoration(
                                  ...
                                  child: Center(child: CustomText(text: 'withdraw'.tr,color: primaryColor,fontWeight: FontWeight.bold,)))
                            ],
                          ) ,
                        ),
                      )
